...
print("Month with highest rainfall:", highest_month, "Amount of rain:", highest_rainfall)
print("Month with lowest rainfall:", lowest_month, "Amount of rain:", lowest_rainfall)
